...
const data = [
  {
    ...
    desc: [
      ...
      'Dive into "Desert Warriors" where your strategic prowess,teamwork, and adaptability are your greatest assets. Engage in high-stakescombat across ancient ruins, futuristic installations, and unpredictable sanddunes.',
      ...
      "<span class='text-[#70F]'>•  Community-Centric Development: </span> 'Desert Warriors' evolves with you. Your feedback andengagement shape the future, with continuous updates and new content driven bythe community.",
    ],
  ...
  },
  {
    ...
    desc: [
      ...
      "<span class='text-[#0ED4FF]'>•  Community-Centric Development: </span> 'Desert Warriors' evolves with you. Your feedback andengagement shape the future, with continuous updates and new content driven bythe community.",
      ...
      "<span class='text-[#0ED4FF]'>•  Game Modes: </span> Whether you prefer theintensity of 1v1 duels, the strategic depth of 2v2 skirmishes, or the classicteamwork of 5v5 battles, 'Desert Dominion' has a mode for everywarrior.",
    ],
