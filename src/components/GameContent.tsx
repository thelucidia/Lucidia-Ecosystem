const GameContent = () => {
  return (
    <section className="w-full h-auto p-5 relative text-white flex md:items-center justify-center">
      ...
      <div className="max-w-[1400px] w-full sm:h-screen h-auto mx-auto relative z-10 flex mt-[7rem] md:mt-[10rem] flex flex-col relative gap-y-5">
      ...
      <img src="/hero/navline.webp" alt="Navline" className="absolute z-11 left-0 bottom-5 w-full xl:block hidden" />O
    </section>
    // <section>
