    ...
    <section className="w-full min-h-screen relative py-10 sm:pt-28 pt-16">
      <div className="w-full h-full overflow-hidden px-5">
        <div className="max-w-[1400px] w-full mx-auto flex lg:gap-x-32 justify-center lg:flex-row flex-col lg:items-start items-center">
          <div className="md:w-[60%]  text-white relative top-[390px] z-10 text-center lg:text-left overflow-hidden">
            <motion.div
              initial={{ x: -150 }}
              whileInView={{ x: 0 }}
            ...
            >
              <div>
                <h1 className="font-medium text-transparent min-w-[360px] text-[62px] sm:text-[62px] font-primary bg-clip-text bg-gradient-to-r from-white via-[#cab8ff] to-white sm:max-w-[12rem] mx-auto lg:mx-0">
